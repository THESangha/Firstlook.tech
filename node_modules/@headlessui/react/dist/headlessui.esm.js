import React, { Fragment, isValidElement, cloneElement, createElement, forwardRef, useCallback, useRef, useEffect, useLayoutEffect, useState, createContext, useContext, useMemo, useReducer, createRef } from 'react';
...
function RadioGroup(props) {
  ...
  var reducerBag = useReducer(stateReducer$5, {
    propsRef: {
      current: {
        value: value,
        onChange: onChange
...
export { Dialog, Disclosure, FocusTrap, Listbox, Menu, Popover, Portal, RadioGroup, Switch, Transition };
